...
import (
	...
	"github.com/landonr/bruxism/carbonitexplugin"
	"github.com/landonr/bruxism/chartplugin"
	"github.com/landonr/bruxism/comicplugin"
	"github.com/landonr/bruxism/discordavatarplugin"
	"github.com/landonr/bruxism/emojiplugin"
	"github.com/landonr/bruxism/inviteplugin"
	"github.com/landonr/bruxism/liveplugin"
	"github.com/landonr/bruxism/musicplugin"
	"github.com/landonr/bruxism/mysonplugin"
	"github.com/landonr/bruxism/numbertriviaplugin"
	"github.com/landonr/bruxism/playedplugin"
	"github.com/landonr/bruxism/playingplugin"
	"github.com/landonr/bruxism/reminderplugin"
	"github.com/landonr/bruxism/statsplugin"
	"github.com/landonr/bruxism/streamerplugin"
	"github.com/landonr/bruxism/topstreamersplugin"
	"github.com/landonr/bruxism/triviaplugin"
	"github.com/landonr/bruxism/youtubejoinplugin"
)
...
func main() {
	...
	youtube := bruxism.NewYouTube(false, "", "", "")
	ytLiveChannel :=  bruxism.NewYTLiveChannel(nil)
	ytip := youtubejoinplugin.New(nil)

	if(youtubeConfigFilename != "") {
		...
		log.Println("Registering Youtube Service")
	...
	if (discordEmail != "" && discordPassword != "") || discordToken != "" {
		...
		log.Println("Registering Discord Service")
	...
	if ircServer != "" && ircUsername != "" {
		...
		log.Println("Registering IRC Service")
	...
	if slackToken != "" {
		...
		log.Println("Registering Slack Service")
